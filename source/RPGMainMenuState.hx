...
class RPGMainMenuState extends RPGState
{
  ...
  function LoadMainMenu(){
      ...
      FlxTween.tween(player,{y:360, angle:360*5}, 1, {ease: FlxEase.sineIn, onComplete:
      ...
      FlxTween.num(0.7,1, 0.49, {type: FlxTween.PINGPONG, ease: FlxEase.sineInOut},
            function(val:Float){
                rect.alpha = val;
            }
      );
      ...
      //Tween Lights
      FlxTween.num(0.4,1, 2, {type: FlxTween.PINGPONG},
            function(val:Float){
                rect.alpha = val;
      ...
      //Dialogs
      var dialogTrig = CreateDialogTrigger(["A Gamecube hooked to an old TV", "Super Smashing Fighters is playing on it."], [FlxColor.WHITE, FlxColor.WHITE], [1, 2], function(){ return FlxG.switchState(new FreeplayState());});
      ...
      var dialogTrig = CreateDialogTrigger(["A PC running Windows XP.", "The control panel is open."], [FlxColor.WHITE, FlxColor.WHITE], [1, 2], function(){ return FlxG.switchState(new OptionsMenu());});
      ...
      var dialogTrig = CreateDialogTrigger(["The light blinds you."], [FlxColor.WHITE], [1], function(){ return FlxG.switchState(new StoryMenuState());});
      ...
      trace( StringTools.replace(Paths.image('xeventbg/menu', 'shared'), ".png",".csv") );
      currentLevel = LoadLevelCollision(StringTools.replace(Paths.image('xeventbg/menu', 'shared'), ".png",".csv"),Paths.image('xeventbg/tiles16', 'shared'), 0, 0);
